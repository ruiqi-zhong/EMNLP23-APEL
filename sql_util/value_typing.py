...
def type_values_w_db(orig_path: str, typed_values: List[Tuple[Tuple[str, str], str]], loose: bool, db_info = None) \
        -> Dict[Tuple[str, str], List[str]]:
    if db_info is None:
        t2cproperties, dep, table_col2column_elements = get_all_db_info_path(orig_path)
    else:
        t2cproperties, dep, table_col2column_elements = db_info
